#!/bin/bash
# =============================================================================
# Smart DeepCoy Job Submission with Queue Management - WOOJIN ACCOUNT
#
...
#
# Usage:
#   ./submit_deepcoy_smart_woojin.sh                    # Submit for current user
#   ./submit_deepcoy_smart_woojin.sh --start 419 --end 836    # Submit specific range
#   ./submit_deepcoy_smart_woojin.sh --dry-run          # Preview without submitting
#   nohup ./submit_deepcoy_smart_woojin.sh > submit_woojin.log 2>&1 &  # Run in background
# =============================================================================
...
# Set default range for woojin (second half: 419-836)
...
echo "============================================="
echo "Smart DeepCoy Job Submission - WOOJIN"
echo "============================================="
...
echo ""
echo "============================================="
echo "SUBMISSION COMPLETE - WOOJIN"
echo "============================================="
