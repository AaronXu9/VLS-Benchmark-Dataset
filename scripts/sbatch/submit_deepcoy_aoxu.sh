#!/bin/bash
# =============================================================================
# Submit DeepCoy jobs for account: aoxu (first half of targets)
#
# Usage:
#   ./submit_deepcoy_aoxu.sh           # Submit jobs
#   ./submit_deepcoy_aoxu.sh --dry-run # Preview without submitting
# =============================================================================
...
# Account aoxu gets first half (indices 0 to HALF-1)
START_IDX=0
END_IDX=$((HALF - 1))
...
echo "This account processes: ${START_IDX} to ${END_IDX} (${HALF} targets)"
